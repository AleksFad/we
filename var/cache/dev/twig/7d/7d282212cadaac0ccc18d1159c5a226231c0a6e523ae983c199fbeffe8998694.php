...
class Legend {
    ...
    get(category) {
        return this.category.find(element => element.value === category) || this.createCategory(category);
    }
...
", "@WebProfiler/Collector/time.js", "/Users/tactic/news-portal/vendor/symfony/web-profiler-bundle/Resources/views/Collector/time.js");
    }
}
